...
HD_PWD='C:/Users/Alexander/Documents/Master_Embedded/SoC_Lab/Run-Time-Power-Monitoring/vivado/PE_demo/PE_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_puls.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source btn_puls.tcl
