...
HD_PWD='C:/Users/Alexander/Documents/Master_Embedded/SoC_Lab/SV_Testbench_vhdlMemory/SV_Testbench_vhdlMemory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_port_RAM_VHDL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Single_port_RAM_VHDL.tcl -notrace
