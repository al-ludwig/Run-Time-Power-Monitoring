...
HD_PWD='C:/Users/Alexander/Documents/Master_Embedded/SoC_Lab/SV_Testbench_vhdlMemory/SV_Testbench_vhdlMemory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_port_RAM_VHDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Single_port_RAM_VHDL.tcl
